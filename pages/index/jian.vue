		...
		<view class="newview1" v-else v-for="(item,index) in listdata" :key="index">
			<view style="padding: 0 30rpx;">
				...
				<view class="plview">
					<u-row gutter="16">
						<u-col span="4">
							<view class="demo-layout bg-purple" style="text-align: center;" v-if="item.dz==0"
						...
						<u-col span="4">
							<view class="demo-layout bg-purple-light" style="text-align: center;"
								@click="newxqclick(item.id)">
						...
						<u-col span="4">
							<view class="demo-layout bg-purple-dark" style="text-align: center;" v-if="item.sc==0"
